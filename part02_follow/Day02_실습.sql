...
-- 연도별 사원수, 총급여, 평균급여, 최대급여, 최소급여 조회
-- ㄴ 소수점 X, 3자리 구분
-- ㄴ 총급여가 30000 이상인 년도 출력
-- ㄴ 급여 협상이 안된 사원은 제외 (salary가 null인 사원은 제외)
...
-- ㄴ 총급여가 30000 이상인 년도 출력
-- ㄴ 급여 협상이 안된 사원은 제외 (salary가 null인 사원은 제외)
-- ㄴ select if(grouping(left(hire_date, 4)), '총합계', ifnull(dept_id, '-')) 연도, / 함수가 있기에 동작 안함, 사용 빈도가 낮아 버전 릴리즈에 반영되지 않음
