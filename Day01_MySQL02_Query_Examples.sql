...
-- ㄴ 사원명이 홍길동인 사원을 별칭으로 조회? ::: WHERE 조건절에서 별칭을 컬럼명으로 사용할 수 없음
	SELECT EMP_ID AS '사원번호', EMP_NAME AS '사원명', ENG_NAME, GENDER, HIRE_DATE, SALARY
...
-- ㄴ HIRE_DATE, SALARY 컬럼은 '입사일', '급여' 별칭으로 컬럼리스트 생성 후 정렬
...
-- ㄴ 급여가 NULL인 사원의 보너스는 기본 50
-- ㄴ 보너스가 1000 이상인 사원 조회
-- ㄴ 보너스가 높은 사원 기준으로 정렬
...
-- BETWEEN ~ AND
-- ㄴ 특정 기간 : 2015-01-01 ~ 2017-12-31 사이에 입사한 모든 사원 조회
-- ㄴ 부서기준으로 오름차순 정렬
